...
- **Video Upload**: Analyze emotions frame by frame in a video.
...
> These files are **not included** in the repository. You must add them manually via running the `Main.py`.
